            ...
            <div class="panel-body">
                ...
                <form v-on:submit.prevent="onSubmit" class="form-horizontal" role="form" method="POST">
                    ...
                    <div class="form-group">
                        <label for="name" class="col-md-4 control-label">Action Name</label>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            onSubmit: function(){
                    // User Input
                    var action = this.newAction;

                    // Clear Form Input
                    this.newAction = { id: '', name:'' }
            ...
            onSuccess: function(){
                ...
                this.message = 'New Action Type Created!';
                this.getActions();
            ...
            getActions: function(){
                ...
                axios.get('/api/actions')
                    .then(response => this.shared.action_types = response.data );
